...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
      ...
      <img src="assets/images/marci2.png">
      </div>
    </div>

      <div id="sub" class="row" style="text-align: center;">
      <div class="col-sm-4 ">
        <h4>Oferta noastra cuprinde:</h4>
      </div>
       <div class="col-sm-4 " >
        <h4>Bun Venit !</h4>
      </div>
    ...
    <div id="sub" class="row" >
      <div class="col-sm-4" >
       ...
       <div class="col-sm-4 " >
        <img src="assets/images/add.jpg" class="img-rounded" width="300" height="190">
      </div>
       <div class="col-sm-4">
    ...
    <div id="sub" class="row" style="text-align: center;">
      <div class="col-sm-4" >
        Servicii complete de:</br>
        mecanica - electrica</br>
        tinichigerie - vopsitorie</br>
        tractari auto</br>
      </div>
