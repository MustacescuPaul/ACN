...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3">
          <img class="img-rounded" src="assets/images/mec.jpg" width="300" height="200">
        </div>
        <div class="col-sm-7 col-sm-offset-1">
        	 AutoCaNou efectueaza o gama larga de reparatii mecanice intr-un atelier special amenajat, cu personal bine pregatit.
